package com.example.covidvaccinationapp.view;
...
import com.example.covidvaccinationapp.adapter.VaccinationInfoAdapter;
        ...
        @Override
           ...
           try {
               ...
               for (int i = 0; i < sessionArray.length(); i++) {
                   ...
                   vaccineModel.setVaccinationTime(sesObject.getString("to"));
